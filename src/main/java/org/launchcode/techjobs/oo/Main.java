...
reasons to do this:
    ...
    beyond reducing raw memory data, this updates data, say employer name,
        in one place, Employer object representing company instance

    enable extension --> adding future properties

    say an Employer object has an address, primary contact, & employer's available job list
        useful info for Location object includes zip code list for that location,
            to determine city & state for employer or job

    to store these four new properties as strings within Job class,
        extending & modifying this behavior becomes too complex
...
use inheritance to DRY Employer, Location, CoreCompetency, & PositionType classes
